...
2. HOW MANY bomb sorties were launched, in total, against the most attacked hamlet in Vietnam? Note: you'll want to "group by" hamlet ID to answer this question. (1 point)
...
3. Calculate the PERCENT of observations in each control category. Overall, what is the most common control status? (1 point)
